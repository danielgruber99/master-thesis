...
This chapter focuses on the implementation and evaluation of coroutines in various pointer-chasing data structures,
including chaining hash tables, linear probing hash tables, and B+ trees.
It explains how coroutines are integrated into these data structures to hide cache misses during lookups
and presents benchmarking results to assess their performance impact.

% why do I use these data structures? and not others, because they are widely used in databases and other systems that require efficient data retrieval.
